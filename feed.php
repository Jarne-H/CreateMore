...
<body>
    ...
    <?php if (isset($_SESSION['email'])) :?>
        ...
        <?php if (isset($_SESSION['email'])):?>
        <p><span><?php echo 0?></span><img src="./assets/actie.png" alt="like"></p>
        <p><span><?php echo 0?></span><img src="./assets/comment.png" alt="comment"></p>
        <?php endif;?>
        </div>
    ...
    <?php endforeach;?>
                ...
                <a href="#" id="leftButton"><img class="arrow" src="./assets/lArrow.png" alt="left Arrow"></a>
                <a href="#" id="rightButton"><img class="arrow"src="./assets/rArrow.png" alt="right Arrow"></a>
        
    
  <div id="downloadButton"> 
         <a  href=""><button id="download" ><img src="./assets/download.png" alt=""></button></a>
         </div>    
</body>
</html>